...
def main(device, args):
    ...
    for iter in range(args.num_epochs):
        ...
        if iter % 1 == 0:
            ...
            # 保存最佳模型状态字典
        torch.save(best_model_state, 'C:\\Users\PS\Desktop\\fedcon-pytorch-master\\result\\brain tumor\\ours\\ablation study\\value of loss terms\\0.01 iid\\0.0001\\best_model_state.pth')
